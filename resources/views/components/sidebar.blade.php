      ...
      <div id="sidebar" class="sidebar sidebar-with-footer">
          ...
          <div class="sidebar-left" data-simplebar style="height: 100%;">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  @php
                      $menuItems = [
                          ['label' => 'Contacts', 'url' => 'contacts', 'icon' => 'mdi-phone'],
                          ['label' => 'Team', 'url' => 'team', 'icon' => 'mdi-account-group'],                          
                  ...
                  <li class="has-sub">
                      <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)" data-toggle="collapse"
                          data-target="#staff" aria-expanded="false" aria-controls="staff">
                          <i class="mdi mdi-account-multiple"></i>
                          <span class="nav-text">Staff</span> <b class="caret"></b>
                      </a>
                      <ul class="collapse" id="staff" data-parent="#sidebar-menu">
                          <div class="sub-menu">

                              <li>
                                  <a class="sidenav-item-link" href="/index_staff">
                                    <i class="mdi mdi-account-multiple"></i>
                              ...
                              <li>
                                  <a class="sidenav-item-link" href="/create_staff">
                                      <span class="nav-text">Tambah Staff</span>
                  ...
                  <li class="has-sub">
                      ...
                      <ul class="collapse" id="ui-elements" data-parent="#sidebar-menu">
                          <div class="sub-menu">
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#buttons" aria-expanded="false"
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#tables" aria-expanded="false"
                                  ...
                                  <ul class="collapse" id="tables">
                                      <div class="sub-menu">
                                          ...
                                          <li>
                                              <a href="{{ asset('theme') }}/bootstarp-tables.html">Bootstrap
                                                  Tables</a>
                                          </li>
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#icons" aria-expanded="false"
                                      aria-controls="icons">
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#forms" aria-expanded="false"
                                      aria-controls="forms">
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#maps" aria-expanded="false"
                                      aria-controls="maps">
                              ...
                              <li class="has-sub">
                                  <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                                      data-toggle="collapse" data-target="#widgets" aria-expanded="false"
                  ...
                  <li class="has-sub">
                      <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                          data-toggle="collapse" data-target="#users" aria-expanded="false" aria-controls="users">
                          ...
                          <div class="sub-menu">
                              ...
                              <li>
                                  <a class="sidenav-item-link"
                                      href="{{ asset('theme') }}/user-profile-settings.html">
                              ...
                              <li>
                                  <a class="sidenav-item-link"
                                      href="{{ asset('theme') }}/user-account-settings.html">
                              ...
                              <li>
                                  <a class="sidenav-item-link"
                                      href="{{ asset('theme') }}/user-planing-settings.html">
                  ...
                  <li class="has-sub">
                      <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                          data-toggle="collapse" data-target="#authentication" aria-expanded="false"
                  ...
                  <li class="has-sub">
                      <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                          data-toggle="collapse" data-target="#other-page" aria-expanded="false"
                  ...
                  <li class="has-sub">
                      <a class="sidenav-item-link" href="{{ asset('theme') }}/javascript:void(0)"
                          data-toggle="collapse" data-target="#customization" aria-expanded="false"
                      ...
                      <ul class="collapse" id="customization" data-parent="#sidebar-menu">
                          <div class="sub-menu">
                              ...
                              <li>
                                  <a class="sidenav-item-link"
                                      href="{{ asset('theme') }}/sidebar-customization.html">
          ...
          <div class="sidebar-footer">
              <div class="sidebar-footer-content">
                  <ul class="d-flex">
                      <li>
                          <a href="{{ asset('theme') }}/user-account-settings.html" data-toggle="tooltip"
                              title="Profile settings"><i class="mdi mdi-settings"></i></a>
                      </li>
                      <li>
                          <a href="{{ asset('theme') }}/#" data-toggle="tooltip" title="No chat messages"><i

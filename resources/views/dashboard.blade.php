                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card card-default card-mini">
                        <div class="card-header">
                            <h2>$18,699</h2>
                            <div class="dropdown">
                                <a class="dropdown-toggle icon-burger-mini" href="{{ asset('theme') }}/#" role="button"
                                    id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                </a>

                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Action</a>
                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Another action</a>
                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Something else here</a>
                                </div>
                            </div>
                            <div class="sub-title">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-footer bg-white py-4">
                            <a href="{{ asset('theme') }}/#" class="text-uppercase">Current Users Overview</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="{{ asset('theme') }}/#" role="button"
                                    id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="card-body">
                            <table id="productsTable" class="table table-hover table-product" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-01.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Coach Swagger</td>
                                        <td>24541</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <a class="dropdown-toggle icon-burger-mini" href="{{ asset('theme') }}/#"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right"
                                                    ...
                                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Action</a>
                                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Another
                                                        action</a>
                                                    <a class="dropdown-item" href="{{ asset('theme') }}/#">Something else
                                                        here</a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-02.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-03.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-04.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-05.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-06.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Olay</td>
                                        <td>24546</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-07.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Ledger Nano X</td>
                                        <td>24547</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-08.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-09.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-10.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Wattbike Atom</td>
                                        <td>24550</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-11.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Smart Watch</td>
                                        <td>24551</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-12.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-13.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-14.jpg"
                                                alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="{{ asset('theme') }}/images/products/products-xs-15.jpg"
                                                alt="Product Image">
                                        </td>
                                        <td>Headphones</td>
                                        <td>24555</td>
                        ...
                        <div class="card-body">
                            <table class="table table-borderless table-thead-border">
                                ...
                                <tfoot class="border-top">
                                    <tr>
                                        <td><a href="{{ asset('theme') }}/#" class="text-uppercase">See All</a></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-default">
                        <div class="card-header align-items-center">
                            ...
                            <a href="{{ asset('theme') }}/#" class="btn btn-primary btn-pill" data-toggle="modal"

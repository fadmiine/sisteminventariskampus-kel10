                    ...
                    <div class="col-xl-3 col-sm-6">
                      <div class="card card-default card-mini">
                        <div class="card-header">
                          <h2>$18,699</h2>
                          <div class="dropdown">
                            <a class="dropdown-toggle icon-burger-mini" href="{{ asset('theme') }}/#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            </a>
                  ...
                  <div class="col-xl-8">
                    ...
                    <div class="card card-default">
                      <div class="card-header">
                        ...
                        <div class="dropdown">
                          <a class="dropdown-toggle icon-burger-mini" href="{{ asset('theme') }}/#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                  ...
                  <div class="col-12">
                    <div class="card card-default">
                      <div class="card-header">
                        ...
                        <div class="dropdown">
                          <a class="dropdown-toggle" href="{{ asset('theme') }}/#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-default">
                      <div class="card-header align-items-center">
                        ...
                        <a href="{{ asset('theme') }}/#" class="btn btn-primary btn-pill" data-toggle="modal" data-target="#modal-stock">Add Stock</a>
                      </div>
                      <div class="card-body">
                      ...
                      <div class="card card-default chat">
                        <div class="card-header">
                          ...
                          <div class="dropdown dropdown-chat-state">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              <li>
                                <a href="{{ asset('theme') }}/#" class="user-link">
                        ...
                        <div class="card-body pb-0" data-simplebar style="height: 363px;">
                          ...
                          <div class="media media-chat">
                            <img src="{{ asset('theme') }}/images/user/user-sm-01.jpg" class="rounded-circle" alt="Avata Image">
                          ...
                          <div class="media media-chat media-chat-right">
                            ...
                            <img src="{{ asset('theme') }}/images/user/user-sm-02.jpg" class="rounded-circle" alt="Avata Image">
                          </div>
